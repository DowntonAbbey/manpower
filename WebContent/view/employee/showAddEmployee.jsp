    	 ...
    	 <form action="${pageContext.request.contextPath}/emps" id="employeeForm" method="post">
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">姓名：<input type="text" name="empName" id="name" size="20"/></td>
		    			<td class="font3 fftd">身份证号码：<input type="text" name="cardNum" id="cardId" size="20"/></td>
		    		</tr>
		    		<tr>
		    		...
		    		<tr>
		    			...
		    			<td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input name="phone" id="tel" size="20"/></td>
		    		</tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					爱&nbsp;&nbsp;&nbsp;&nbsp;好：<input name="habiit" id="hobby" size="20"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>

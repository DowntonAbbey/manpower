...
<html>
	...
	$(function(){
		// 控制文档加载完成以后 选中性别 
		$("#sex").val("${employee.gender}");
		$("#job_id").val("${employee.staffId}");
		$("#dept_id").val("${employee.dId}");
		$("#birthday").val("${employee.birth}");
...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/emps" id="employeeForm" method="post">
			<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">姓名：<input type="text" name="empName" id="name" size="20" value="${employee.empName }"/></td>
		    			<td class="font3 fftd">身份证号码：<input type="text" name="cardNum" id="cardId" size="20" value="${employee.cardNum }"/></td>
		    		</tr>
		    		<tr>
		    			...
		    			<td class="font3 fftd">职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;位：
		    			 	<select id="job_id" name="staffId" style="width:143px;">
					    			<option value="0">--选择职位--</option>
					    			<c:forEach items="${staffs}" var="job">
					    				<option value="${job.staffId }">${job.staffName }</option>
					    			</c:forEach>
					    		</select>
					    </td>
		    		</tr>
		    		<tr>
		    			<td class="font3 fftd">学历：<input name="empEdu" id="education" size="20" value="${employee.empEdu }"/></td>
		    			<td class="font3 fftd">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input name="email" id="email" size="20" value="${employee.email }"/></td>
		    		</tr>
		    		<tr>
		    			<td class="font3 fftd">手机：<input name="telNum" id="phone" size="20" value="${employee.telNum }"/></td>
		    			<td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input name="phone" id="tel" size="20" value="${employee.phone }"/></td>
		    		</tr>
			...
			<tr>
				<td class="font3 fftd">
					政治面貌：<input name="political" id="party" size="40" value="${employee.political }"/>&nbsp;&nbsp;
			...
			<tr>
				<td class="font3 fftd">
					联系地址：<input name="empAddress" id="address" size="40" value="${employee.empAddress }"/>&nbsp;&nbsp;
					邮政编码：<input name="ems" id="postCode" size="20" value="${employee.ems }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					...
					民&nbsp;&nbsp;&nbsp;&nbsp;族：<input name="volk" id="race" size="20" value="${employee.volk }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>
			...
			<tr>
				<td class="font3 fftd">
					所学专业：<input  name="major" id="speciality" size="40" value="${employee.major }"/>&nbsp;&nbsp;
					爱&nbsp;&nbsp;&nbsp;&nbsp;好：<input name="habiit" id="hobby" size="20" value="${employee.habiit }"/>
				</td>
			</tr>
			<tr><td class="main_tdbor"></td></tr>

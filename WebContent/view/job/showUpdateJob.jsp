...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath}/staffs" id="jobForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
    	 	<input type="hidden" name="flag" value="2">
    	 	<input type="hidden" name="method" value="updateStaff">
    	 	<input type="hidden" name="staffId" value="${job.staffId }">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			<td class="font3 fftd">职位名称：<input type="text" name="staffName" id="name" size="20" value="${job.staffName}"/></td>
		    			<td class="font3 fftd">详细描述：<input type="text" name="staffDes" id="remark" size="20" value="${job.staffDes}"/></td>
		    		</tr>

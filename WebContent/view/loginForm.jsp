...
<link
	href="${pageContext.request.contextPath}/js/metronic/plugins/bootstrap/css/bootstrap.min.css"
...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		...
		<form action="${pageContext.request.contextPath}/UserServlet" method="post"
			id="loginForm">
			<!--影藏域 进场用来传输后台需要的数据 但是前台 不需要展示的数据-->
						...
						<div class="controls">
							<div class="input-icon left">
								...
								<input
									...
									id="loginname" name="userName" value="${userLoginName}">
							</div>
						</div>
					</div>
					<div class="control-group">
